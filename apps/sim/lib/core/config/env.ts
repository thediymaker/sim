...
export const env = createEnv({
  ...
  server: {
    ...
    OPENAI_BASE_URL:                       z.string().url().optional(),            // Custom OpenAI-compatible base URL (e.g. for LiteLLM proxy)
    LITELLM_BASE_URL:                      z.string().url().optional().default('https://ai.rc.asu.edu'),  // LiteLLM proxy base URL
    LITELLM_API_KEY:                       z.string().optional(),                  // LiteLLM proxy API key
